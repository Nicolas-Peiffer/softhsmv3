...
pub const CKR_KEY_UNEXTRACTABLE: u32 = 0x0000006A;
pub const CKR_KEY_FUNCTION_NOT_PERMITTED: u32 = 0x00000068;
...
pub const CKA_PUBLIC_KEY_INFO: u32 = 0x00000129; // PKCS#11 v3.2 — DER SubjectPublicKeyInfo
pub const CKA_PARAMETER_SET: u32 = 0x0000061d;

// ── PKCS#11 Object Classes ────────────────────────────────────────────────────

const CKO_PUBLIC_KEY: u32  = 0x00000002;
const CKO_PRIVATE_KEY: u32 = 0x00000003;
const CKO_SECRET_KEY: u32  = 0x00000004;

// ── PKCS#11 Key Types (CKK_*) ────────────────────────────────────────────────

const CKK_RSA: u32            = 0x00000000;
const CKK_EC: u32             = 0x00000003; // ECDSA (P-256, P-384)
const CKK_GENERIC_SECRET: u32 = 0x00000010;
const CKK_AES: u32            = 0x0000001f;
const CKK_EC_EDWARDS: u32     = 0x00000040; // EdDSA (Ed25519)
const CKK_ML_KEM: u32         = 0x00000049;
const CKK_ML_DSA: u32         = 0x0000004a;
const CKK_SLH_DSA: u32        = 0x0000004b;

// ── PKCS#11 Semantic Attribute Types ─────────────────────────────────────────

const CKA_CLASS: u32       = 0x00000000;
const CKA_TOKEN: u32       = 0x00000001;
const CKA_PRIVATE: u32     = 0x00000002;
const CKA_SENSITIVE: u32   = 0x00000103;
const CKA_ENCRYPT: u32     = 0x00000104;
const CKA_DECRYPT: u32     = 0x00000105;
const CKA_WRAP: u32        = 0x00000106;
const CKA_UNWRAP: u32      = 0x00000107;
const CKA_SIGN: u32        = 0x00000108;
const CKA_VERIFY: u32      = 0x0000010a;
const CKA_DERIVE: u32      = 0x0000010c;
const CKA_EXTRACTABLE: u32        = 0x00000162;
const CKA_LOCAL: u32              = 0x00000163;
const CKA_NEVER_EXTRACTABLE: u32  = 0x00000164;
const CKA_ALWAYS_SENSITIVE: u32   = 0x00000165;
const CKA_KEY_GEN_MECHANISM: u32  = 0x00000166;
const CKA_ENCAPSULATE: u32        = 0x00000633;
const CKA_DECAPSULATE: u32        = 0x00000634;
...
pub const CKM_HASH_ML_DSA_SHA224:   u32 = 0x00000023;
pub const CKM_HASH_ML_DSA_SHA256:   u32 = 0x00000024;
pub const CKM_HASH_ML_DSA_SHA384:   u32 = 0x00000025;
pub const CKM_HASH_ML_DSA_SHA512:   u32 = 0x00000026;
pub const CKM_HASH_ML_DSA_SHA3_224: u32 = 0x00000027;
pub const CKM_HASH_ML_DSA_SHA3_256: u32 = 0x00000028;
pub const CKM_HASH_ML_DSA_SHA3_384: u32 = 0x00000029;
pub const CKM_HASH_ML_DSA_SHA3_512: u32 = 0x0000002a;
pub const CKM_HASH_ML_DSA_SHAKE128: u32 = 0x0000002b;
pub const CKM_HASH_ML_DSA_SHAKE256: u32 = 0x0000002c;

// SLH-DSA pre-hash mechanisms (PKCS#11 v3.2, pkcs11t.h §1235-1245)
pub const CKM_HASH_SLH_DSA_SHA224:   u32 = 0x00000036;
pub const CKM_HASH_SLH_DSA_SHA256:   u32 = 0x00000037;
pub const CKM_HASH_SLH_DSA_SHA384:   u32 = 0x00000038;
pub const CKM_HASH_SLH_DSA_SHA512:   u32 = 0x00000039;
pub const CKM_HASH_SLH_DSA_SHA3_224: u32 = 0x0000003a;
pub const CKM_HASH_SLH_DSA_SHA3_256: u32 = 0x0000003b;
pub const CKM_HASH_SLH_DSA_SHA3_384: u32 = 0x0000003c;
pub const CKM_HASH_SLH_DSA_SHA3_512: u32 = 0x0000003d;
pub const CKM_HASH_SLH_DSA_SHAKE128: u32 = 0x0000003e;
pub const CKM_HASH_SLH_DSA_SHAKE256: u32 = 0x0000003f;
...
pub const CKM_ECDSA_SHA3_224: u32 = 0x00001047;
pub const CKM_ECDSA_SHA3_256: u32 = 0x00001048;
pub const CKM_ECDSA_SHA3_384: u32 = 0x00001049;
pub const CKM_ECDSA_SHA3_512: u32 = 0x0000104a;
...
const CKM_EDDSA_PH: u32 = 0xFFFF1057;

// AES
pub const CKM_AES_KEY_GEN: u32 = 0x00001080;
pub const CKM_AES_CBC_PAD: u32 = 0x00001085;
pub const CKM_AES_CTR: u32 = 0x00001086;
pub const CKM_AES_GCM: u32 = 0x00001087;
pub const CKM_AES_KEY_WRAP: u32 = 0x00002109;
pub const CKM_AES_KEY_WRAP_KWP: u32 = 0x0000210A; // RFC 5649 (PKCS#11 v3.2)
const CKM_AES_KEY_WRAP_PAD_LEGACY: u32 = 0x0000108b; // SoftHSM2 legacy alias
...
fn store_bool(attrs: &mut Attributes, attr_type: u32, value: bool) {
    attrs.insert(attr_type, vec![if value { 0x01 } else { 0x00 }]);
}

/// Store a CK_ULONG attribute (4-byte little-endian).
fn store_ulong(attrs: &mut Attributes, attr_type: u32, value: u32) {
...
fn read_bool_attr(attrs: &Attributes, attr_type: u32) -> bool {
    attrs
        .get(&attr_type)
...
fn finalize_private_key_attrs(attrs: &mut Attributes) {
...
unsafe fn absorb_template_attrs(attrs: &mut Attributes, template: *mut u8, count: u32) {
...
fn build_ec_spki_p256(pt: &[u8]) -> Vec<u8> {
...
fn build_ec_spki_p384(pt: &[u8]) -> Vec<u8> {
...
fn build_ed25519_spki(pk: &[u8]) -> Vec<u8> {
...
fn build_spki_from_parts(alg_id: &[u8], key_bytes: &[u8]) -> Vec<u8> {
...
fn is_prehash_ml_dsa(mech: u32) -> bool {
    matches!(
        mech,
        CKM_HASH_ML_DSA_SHA224
            | CKM_HASH_ML_DSA_SHA256
...
fn is_prehash_slh_dsa(mech: u32) -> bool {
    matches!(
        mech,
        CKM_HASH_SLH_DSA_SHA224
            | CKM_HASH_SLH_DSA_SHA256
...
fn sign_eddsa_ph(sk_bytes: &[u8], msg: &[u8]) -> Result<Vec<u8>, u32> {
    use sha2::Digest;
    if sk_bytes.len() != 32 {
        return Err(CKR_KEY_TYPE_INCONSISTENT);
    }
...
fn verify_eddsa_ph(pk_bytes: &[u8], msg: &[u8], sig_bytes: &[u8]) -> Result<(), u32> {
    use sha2::Digest;
    if pk_bytes.len() != 32 || sig_bytes.len() != 64 {
        return Err(CKR_KEY_TYPE_INCONSISTENT);
    }
...
const CKR_FUNCTION_NOT_SUPPORTED: u32 = 0x00000054;
