...
pub enum Ph {
    ...
    SHAKE128,
    /// Use Shake256 as the pre-hash function (512-bit output)
    SHAKE256,
    /// Use SHA224 as the pre-hash function [PKCS#11 v3.2 CKM_HASH_SLH_DSA_SHA224]
    SHA224,
    /// Use SHA384 as the pre-hash function [PKCS#11 v3.2 CKM_HASH_SLH_DSA_SHA384]
    SHA384,
    /// Use SHA3-224 as the pre-hash function [PKCS#11 v3.2 CKM_HASH_SLH_DSA_SHA3_224]
    SHA3_224,
    /// Use SHA3-256 as the pre-hash function [PKCS#11 v3.2 CKM_HASH_SLH_DSA_SHA3_256]
    SHA3_256,
    /// Use SHA3-384 as the pre-hash function [PKCS#11 v3.2 CKM_HASH_SLH_DSA_SHA3_384]
    SHA3_384,
    /// Use SHA3-512 as the pre-hash function [PKCS#11 v3.2 CKM_HASH_SLH_DSA_SHA3_512]
    SHA3_512,
}
