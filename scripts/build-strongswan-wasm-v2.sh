...
emcc \
    ...
    -s EXPORTED_FUNCTIONS='["_main","_wasm_vpn_boot","_wasm_vpn_shutdown","_wasm_vpn_pkcs11_probe","_wasm_vpn_configure_json","_wasm_vpn_initiate","_wasm_vpn_get_result","_malloc","_free"]' \
