...
function findWasmBinary() {
  return locateFile('strongswan-v2-boot.wasm');
}
...
var findStringEnd = (heapOrArray, idx, maxBytesToRead, ignoreNul) => {
  ...
  try {
      ...
      function makeNotifyCallback(stream, pollfd) {
        var cb = (flags) => {
          ...
          flags &= events | 8 | 16;
          assert(flags)
          HEAP16[(((pollfd)+(6))>>1)] = flags;checkInt16(flags);
          asyncPollComplete(1);
        }
  ...
  var _setprotoent = (stayopen) => {
      ...
      function allocprotoent(name, proto, aliases) {
        ...
        HEAP32[(((pe)+(8))>>2)] = proto;checkInt32(proto);
        return pe;
      };
...
function wasm_vpn_emit(type,payload) { if (typeof Module.onVpnEvent === 'function') { Module.onVpnEvent(UTF8ToString(type), UTF8ToString(payload)); } }
...
var _wasm_vpn_validate_proposal = Module['_wasm_vpn_validate_proposal'] = makeInvalidEarlyAccess('_wasm_vpn_validate_proposal');
var _wasm_vpn_validate_cert = Module['_wasm_vpn_validate_cert'] = makeInvalidEarlyAccess('_wasm_vpn_validate_cert');
var _wasm_vpn_list_key_exchanges = Module['_wasm_vpn_list_key_exchanges'] = makeInvalidEarlyAccess('_wasm_vpn_list_key_exchanges');
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports['wasm_vpn_validate_proposal'] != 'undefined', 'missing Wasm export: wasm_vpn_validate_proposal');
  assert(typeof wasmExports['wasm_vpn_validate_cert'] != 'undefined', 'missing Wasm export: wasm_vpn_validate_cert');
  assert(typeof wasmExports['wasm_vpn_list_key_exchanges'] != 'undefined', 'missing Wasm export: wasm_vpn_list_key_exchanges');
  ...
  _wasm_vpn_validate_proposal = Module['_wasm_vpn_validate_proposal'] = createExportWrapper('wasm_vpn_validate_proposal', 1);
  _wasm_vpn_validate_cert = Module['_wasm_vpn_validate_cert'] = createExportWrapper('wasm_vpn_validate_cert', 2);
  _wasm_vpn_list_key_exchanges = Module['_wasm_vpn_list_key_exchanges'] = createExportWrapper('wasm_vpn_list_key_exchanges', 0);
...
if (typeof exports === 'object' && typeof module === 'object') {
  module.exports = StrongswanV2;
  // This default export looks redundant, but it allows TS to import this
  // commonjs style module.
  module.exports.default = StrongswanV2;
